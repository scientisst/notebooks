# ScientISST Notebooks 
 ...
 ## Detailed Index:  
Notebook | Chapter | Tags | Contributors | Last update 
--- | --- | --- | --- | --- 
A001 Open Signals | A | Open Signals, Biosignals, Physiological Signals Acquisition| Rafael Silva, Hugo Plácido da Silva, Ana Fred| 16/05/2022|
...
A011 How to flash a ScientISST board with the official firmware | A | `sense`, `scientisst board`, `firmware`| Rui Maciel, Ana Sofia Carmo| 03/01/23|
...
C004 Live Streaming and Signal Processing | C | ```Serial Port```, ```Python```, ```Live Streaming```, `Signal Processing`| Afonso Raposo, Joana Pinto, Prof. Hugo Silva| 2021|
...
C007 Principles of Biosignal Acquisition | C | `Biosignal Acquisition`, `SENSE`, `SENSE API`, `Data Visualization`| Rafael Silva, Hugo Plácido da Silva, Ana Fred| 16/05/2022|
